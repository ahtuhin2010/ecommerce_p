                      ...
                      <ul class="main-menu">
                          ...
                          <li class="active-menu">
                              ...
                              <ul class="sub-menu">
                                  ...
                                  @else
                                  <li><a href="{{ route('coustomer.login') }}">Checkout</a></li>
                                  @endif
                          ...
                          @else
                          <li><a href="{{ route('coustomer.login') }}">LOGIN</a></li>
                          @endif
                      </ul>
                  </div>
          ...
          <div class="header-cart-content flex-w js-pscroll">
              ...
              <div class="w-full">
                  ...
                  <div class="header-cart-buttons flex-w w-full">
                      ...
                      @else
                      <a href="{{ route('coustomer.login') }}" class="flex-c-m stext-101 cl0 size-107 bg3 bor2 hov-btn3 p-lr-15 trans-04 m-b-10">
                          Check Out
                      </a>
                      @endif
                  </div>
