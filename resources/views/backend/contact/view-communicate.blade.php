                            ...
                            <table id="example1" class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr class="{{ $communicate->id }}">
                                        ...
                                        <td>
                                            <a title="Delete" id="delete" class="btn btn-sm btn-danger" href="{{ route('contacts.communicate.delete') }}" data-token="{{csrf_token()}}" data-id="{{ $communicate->id }}"><i class="fa fa-trash"></i></a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
